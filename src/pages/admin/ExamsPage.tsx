...
import { getExams, addExam, updateExam, deleteExam, getExamQuestions, addExamQuestion, updateExamQuestion, deleteExamQuestion, getSubjects, getClasses, getTeachers, getExamResults } from "@/lib/api";
