...
const parentNav = [
  { title: "لوحة التحكم", icon: LayoutDashboard, path: "/" },
  { title: "أبنائي", icon: Users, path: "/my-children" },
  { title: "الدرجات", icon: GraduationCap, path: "/children-grades" },
  { title: "الحضور", icon: ClipboardCheck, path: "/children-attendance" },
  { title: "الرسائل", icon: MessageSquare, path: "/messages" },
];
